...
export const RipgrepUnavailableNotification =
  new NotificationType<RipgrepUnavailableParams>("deeplens/ripgrepUnavailable");

export const DeepLensSearchRequest = new RequestType<
  SearchOptions,
  SearchResult[],
  void
>("deeplens/search");
