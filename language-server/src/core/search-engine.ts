...
export class SearchEngine implements ISearchProvider {
    ...
    private calculateFuzzyScore(
        ...
        // ⚡ Bolt: O(1) early exits for property-specific fuzzy matching
        // Move the property bitmask checks outside the function calls to avoid
        // function call overhead for items that are immediately rejected.
