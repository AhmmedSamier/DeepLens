...
export const BurstSearchRequest = new RequestType<
  BurstSearchRequestParams,
  BurstSearchRequestResult,
  void
...
export const StreamResultNotification =
  new NotificationType<StreamResultNotificationParams>("deeplens/streamResult");
...
export const ResolveItemsRequest = new RequestType<
  ResolveItemsRequestParams,
  ResolveItemsRequestResult,
  void
...
export const GetRecentItemsRequest = new RequestType<
  GetRecentItemsRequestParams,
  GetRecentItemsRequestResult,
  void
...
export const RecordActivityRequest = new RequestType<
  RecordActivityRequestParams,
  void,
  void
>("deeplens/recordActivity");

export const ClearHistoryRequest = new RequestType0<void, void>(
...
export const RemoveHistoryItemRequest = new RequestType<
  RemoveHistoryItemRequestParams,
  void,
  void
...
export const RebuildIndexRequest = new RequestType<
  RebuildIndexRequestParams,
  void,
  void
>("deeplens/rebuildIndex");

export const ClearCacheRequest = new RequestType0<void, void>(
  "deeplens/clearCache",
);

export const IndexStatsRequest = new RequestType0<IndexStats, void>(
  "deeplens/indexStats",
);
...
export const SetActiveFilesRequest = new RequestType<
  SetActiveFilesRequestParams,
  void,
  void
...
export const DumpIndexRequest = new RequestType0<DumpIndexRequestResult, void>(
  "deeplens/dumpIndex",
);

// ==================== Search Requests ====================

export const SearchRequest = new RequestType<
  SearchOptions,
  SearchResult[],
  void
>("deeplens/search");
...
export const ProgressNotification =
  new NotificationType<ProgressNotificationParams>("deeplens/progress");

// ==================== Ripgrep Unavailable ====================

export const RipgrepUnavailableNotification = new NotificationType<unknown>(
...
export const WorkspaceSymbolRequest = new RequestType<
  WorkspaceSymbolRequestParams,
  WorkspaceSymbolRequestResult,
  void
>("workspace/symbol");
