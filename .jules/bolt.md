...
## 2026-09-07 - [Fast Object Literal Instantiation for Shallow Cloning]
**Learning:** In V8 (Node.js/Bun) hot loops, manually instantiating a new object literal by explicitly setting properties is significantly faster (e.g., ~60x) than `Object.assign` or the spread operator for shallow cloning known structures, as it avoids property iteration and leverages optimized hidden classes.
**Action:** Use manual object instantiation for shallow cloning known structures in hot loops instead of `Object.assign`.
