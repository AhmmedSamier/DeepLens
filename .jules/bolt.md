...
## 2026-06-30 - [O(1) Path Property Early-Exit in Fuzzy Match]
**Learning:** Checking `itemBitflags` is an aggregate check. When falling back to `tryFuzzyMatchPath`, characters might not exist in the path, resulting in wasted fuzzy search cycles.
