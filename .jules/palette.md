...
## 2026-08-02 - Webview Custom Combobox Accessibility Anti-Pattern
**Learning:** Hard-stopping keyboard navigation at index 0 for custom comboboxes prevents users from clearing their selection and returning focus to the input field, breaking screen reader interaction with aria-activedescendant.
**Action:** Always allow custom keyboard navigation indices to reach -1 to correctly clear aria-activedescendant and reset focus to the input field when using ArrowUp.
