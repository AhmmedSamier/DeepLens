...
## 2024-10-24 - ARIA Combobox Navigation
**Learning:** Screen readers require a complete ARIA combobox pattern to announce listbox items, and hard-stopping index at 0 during ArrowUp navigation prevents users from returning focus back to the input to clear selection.
**Action:** When implementing arrow key navigation for custom webview inputs, use role="combobox", aria-expanded, aria-activedescendant, and role="option", and ensure ArrowUp logic allows index to reach -1.
