...
namespace WebAPI.Controllers
{
    ...
    public class AdminDashboardController : ControllerBase
    {
        ...
        try {
            ...
            console.log("Detected Endpoints:", endpoints.map(e => e.name));
...
namespace WebAPI.Controllers.AdminDashboard
{
    ...
    public class AdminDashboardController : AdminBaseController
    {
        ...
        try {
            ...
            console.log("User Controller Endpoints:", endpoints.map(e => e.name));
...
public class MultiAttrController
{
    ...
    public void Upload() {}
        ...
        try {
            ...
            console.log("MultiAttr Endpoints:", endpoints.map(e => e.name));
